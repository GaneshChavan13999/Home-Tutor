...
echo'<fieldset class="fieldset1">';
 echo "<div class='name'>";
	...
	{
		if($row1["action"]==1){
 	echo'<td><a href="pay.php?username='.$_GET["username"].'" class="btn">PAY</a></td>';
	echo"</td>";
	}}
    echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';echo'&nbsp';
	echo'<td><a href="asktutor.php?tname='.$row["name"].'& tusername='.$row["username"].'" class="btn">APPLY</a></td>';
	echo"</td>";
	echo "</div>";
}
