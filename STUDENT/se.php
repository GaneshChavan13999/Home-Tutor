...
//	if(!empty($emails)){
	...
	while($row=$result->fetch_assoc()){
        ...
        $mail->Password = "8850916314";          
        $mail->SMTPSecure = 'tls';       
        $mail->Port = 587;               
        $mail->setFrom("shrutikulaye24@gmail.com", 'HOME TUTOR');
        ...
        $mail->Body    = "Welcome to our website please verify your email this is your OTP:-".$row["otp"];
        $mail->AltBody = "Welcome to our website please verify your email this is your OTP:-".$row["otp"];
